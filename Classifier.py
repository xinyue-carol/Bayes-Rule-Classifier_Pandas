...
#generate a one dimentional cumulative prbabilites:
...
#we want our generated data has all 32(2^5) combination, for both testing and training data set, so this while loop help to ensure that
r=1
while r==1:
